...
public class MLDev implements Employee {
	...
	public MLDev(int empId, String name, String role, double salary, String designation, String dept) {
		super();
		this.empId = empId;
		this.name = name;
		this.role = role;
